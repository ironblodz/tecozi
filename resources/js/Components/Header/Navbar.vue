<template>
    <nav :class="[
        ...
        <!-- Logo à esquerda -->
        <a href="/">
            <!-- Se está em '/', exibe 'logo' senão 'logoOther' -->
            <img :src="isHome ? logo : logoOther" alt="Logo" class="h-10 xl:h-14 mx-4 xl:mx-14 mt-3" />
        </a>

        <!-- Botão de menu (mobile) -->
        <button @click="toggleMenu" :class="[
            'lg:hidden focus:outline-none mr-4',
        ...
        <ul v-if="menuOpen || screenIsLarge"
            ...
            <li>
                <a href="/services" :class="[isHome ? 'text-white' : 'text-black', 'text-base xl:text-lg']">
                    Serviços
                </a>
            </li>
            <li>
                <a href="/materials" :class="[isHome ? 'text-white' : 'text-black', 'text-base xl:text-lg']">
                    Materiais
                </a>
            </li>
            <li>
                <a href="/portfolio" :class="[isHome ? 'text-white' : 'text-black', 'text-base xl:text-lg']">
                    Portfólio
                </a>
            </li>
            ...
            <li class="relative px-12">
                <button @click="toggleLanguageMenu" class="flex items-center space-x-2"
                    ...
                    <!-- Idioma selecionado -->
                    <p :class="{
                        'text-secondary-default': languageMenuOpen,
                        'text-white': isHome && !languageMenuOpen,
                        'text-black': !isHome && !languageMenuOpen
        ...
        <div v-if="screenIsLarge || menuOpen" class="mt-4 lg:mt-0">
            ...
            <button :class="[
                ...
                isHome ? 'bg-secondary-default text-white' : 'bg-primary-default text-white'
            ]">
