        ...
        <div class="container mx-auto w-full grid grid-col justify-center items-center xl:mt-10">
            <div class="flex flex-col  z-20">
                ...
                <h1 class="text-xl xl:text-3xl text-center text-primary-default mt-10">
                    {{ $t('projectdone.title') }}
                    <span class="text-secondary-default text-xl xl:text-3xl"> {{ $t('projectdone.titlev2') }}</span>
                </h1>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-12 mt-20 mx-auto">

                <div class="card bg-primary-default rounded-b-none border-b-8 border-secondary-default text-primary-content w-full  h-36 group hover:border-t-8 hover:border-b-0 transition-all duration-300">
