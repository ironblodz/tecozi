...
<template>
    <div>
        <div class="min-h-screen bg-primary-default">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <Dropdown>
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('portfolio.index')">
                                            Portfólio
                                        </DropdownLink>
                                        <DropdownLink :href="route('portfolio.categories.index')">
                                            Categorias
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
